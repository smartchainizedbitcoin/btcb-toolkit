...
var httpProvider = new Web3__default['default'].providers.HttpProvider(RPC_URL, {
    timeout: 10000,
});
...
var getErc721Contract = function (address, web3) {
    return getContract(erc721Abi, address, web3);
};
var getProfileContract = function (web3, chainId) {
...
var getTokenUriData = function (nftAddress, tokenId, web3) { return __awaiter(void 0, void 0, void 0, function () {
    var contract, tokenUri, uriDataResponse, uriData, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                contract = getErc721Contract(nftAddress, web3);
                return [4 /*yield*/, contract.methods.tokenURI(tokenId).call()];
            case 1:
                tokenUri = _a.sent();
...
var getNftByTokenId = function (nftAddress, tokenId, web3, chainId) { return __awaiter(void 0, void 0, void 0, function () {
    var uriData, identifierKey;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getTokenUriData(nftAddress, tokenId, web3)];
            case 1:
                uriData = _a.sent();
...
var PancakeProfileSdk = /** @class */ (function () {
    function PancakeProfileSdk(args) {
        ...
        this.getTeam = function (teamId) { return __awaiter(_this, void 0, void 0, function () {
            var _a, teamName, numberUsers, numberPoints, isJoinable, staticTeamInfo;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.profileContract.methods.getTeamProfile(teamId).call()];
                    case 1:
                        ...
                        return [2 /*return*/, __assign(__assign({}, staticTeamInfo), { isJoinable: isJoinable, name: teamName, users: numberUsers, points: numberPoints })];
                    case 2:
                        _b.sent();
                        return [2 /*return*/, null];
                    case 3: return [2 /*return*/];
        ...
        this.getProfile = function (address) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 7, , 8]);
                        return [4 /*yield*/, this.profileContract.methods.hasRegistered(address).call()];
                    case 1:
                        hasRegistered = (_b.sent());
                        if (!hasRegistered) {
                            return [2 /*return*/, { hasRegistered: hasRegistered, profile: null }];
                        }
                        return [4 /*yield*/, this.profileContract.methods.getUserProfile(address).call()];
                    case 2:
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, getNftByTokenId(nftAddress, tokenId, this.web3, this.chainId)];
                    case 5:
                        nft = _b.sent();
        ...
        if (args === null || args === void 0 ? void 0 : args.web3)
            this.web3 = args.web3;
...
exports.chaoticCakersAlt = img$e;
exports.chaoticCakersBg = img$a;
exports.chaoticCakersLg = img$b;
exports.chaoticCakersMd = img$c;
exports.chaoticCakersSm = img$d;
exports.default = PancakeProfileSdk;
exports.fearsomeFlippersAlt = img$9;
exports.fearsomeFlippersBg = img$5;
exports.fearsomeFlippersLg = img$6;
exports.fearsomeFlippersMd = img$7;
exports.fearsomeFlippersSm = img$8;
exports.syrupStormAlt = img$4;
exports.syrupStormBg = img;
exports.syrupStormLg = img$1;
exports.syrupStormMd = img$2;
exports.syrupStormSm = img$3;
